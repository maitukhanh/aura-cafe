    ...
    return (
        <div className="p-8">
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
                <div>
                    <h1 className="text-3xl font-black text-coffee uppercase">Danh mục sản phẩm</h1>
                    <p className="text-gray-500 mt-1">Quản lý các nhóm sản phẩm trong hệ thống.</p>
                </div>
                <button
                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y">
                        ...
                        {loading ? (
                            ...
                            <tr><td colSpan={2} className="p-10 text-center text-gray-400 italic">Không tìm thấy danh mục nào.</td></tr>
                        ) : filtered.map(item => (
